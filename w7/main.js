...
function displayOutput() {
  for (obj of cfpData) {
    const firstnameH4 = document.createElement("h4");
    firstnameh4.textContent = `First Name: ${obj.firstName}`;
    const lastNameH5 = document.createElement("h5");
    lastNameh5.textContent = `Last Name: ${obj.lastNameName}`;
    ...
    OUTPUT.appendChild(firstnameH4)
